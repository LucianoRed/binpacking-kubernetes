...
<head>
  ...
  <title>Binpacking + VPA + QoS — Demonstração</title>
...
<body>
  ...
  <main class="container">
    <header class="site-header">
      ...
      <div>
        <h1>Binpacking — VPA com QoS</h1>
        <p class="subtitle">Simulação que inclui pods com QoS (BestEffort, Burstable, Guaranteed) e sugere VPA.</p>
      </div>
    </header>
    ...
    <section class="eviction">
      <h3>Pods evicted (simulação)</h3>
      <div id="evictedList">Nenhum pod evicted.</div>
    </section>
